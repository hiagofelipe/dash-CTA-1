...
(async () => {
  ...
  const soql = "SELECT Id, Name, Etiqueta__c, Produto__c, CreatedDate FROM Opportunity WHERE Produto__c = 'AUVP Consultoria' AND StageName = 'Fechado e ganho' ORDER BY CreatedDate DESC LIMIT 10";
